...
export function revokeKey(options: { key: PrivateKey, reasonForRevocation?: { flag?: enums.reasonForRevocation, string?: String }, date?: Date, config?: PartialConfig }): Promise<PrivateKey>;
export function revokeKey(options: { key: PublicKey, revocationCertificate?: String, date?: Date, config?: PartialConfig }): Promise<PublicKey>;
