 ...
 * @static
 */
export function generateKey({ userIDs = [], passphrase = "", type = "ecc", rsaBits = 4096, curve = "curve25519", keyExpirationTime = 0, date = new Date(), subkeys = [{}], config, symmetricHash = "sha256", symmetricCipher = "aes256" }) {
