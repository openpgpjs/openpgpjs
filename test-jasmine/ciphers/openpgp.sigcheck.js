describe("Binary signature checking", function () {
    ...
    it("CAST5-enciphered message", function () {
        ...
        expect(ret.validSignatures[0]).toBeTruthy();
    });


    it("GnuPG stripped-key extensions", function () {
        ...
        expect(priv_key_gnupg_ext[0].privateKeyPacket.s2k.type).toBe(1001);
        expect(ret2.validSignatures[0]).toBeTruthy();
    });

    it("Keyring public subkey support", function () {
        ...
        expect(pubKey.length).toBe(1);
        expect(msg2[1].signature.verify(msg2[0].data, pubKey[0])).toBeTruthy();
    });
