describe("Blowfish cipher test with test vectors from http://www.schneier.com/code/vectors.txt", function() {
	...
	for (i = 0; i < testvectors.length; i++) {
	    ...
	    it("block: " + util.hexidump(block) + " key: " + util.hexidump(key), function () {
	        ...
	        var res2 = util.hexstrdump(util.bin2str(BFencrypt(block, util.bin2str(key))));
